...
import upperroom.newsletter.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("file", models.FileField(upload_to=upperroom.newsletter.models.get_filename, verbose_name="file")),
                ("mime_type", models.CharField(editable=False, max_length=128, verbose_name="MIME type")),
                ("description", models.TextField(blank=True, null=True, verbose_name="description")),
                (
                    "publication",
                    models.ForeignKey(
                        default=upperroom.newsletter.models.default_publication,
