...
parser.add_argument('--collection',
                    dest='collection',
                    default='The Point Church Sermons')
...
p = subprocess.run(('ffmpeg',
                    ...
                    '-af', ('loudnorm=I={target_i}:'
                            'TP={target_tp}:'
                            'LRA={target_lra}:'
                            'print_format=json').format(target_i=args.target_i,
...
metadata = ['-metadata', 'album=%s' % args.collection,
            '-metadata', 'genre=%s' % args.genre,
            '-metadata', 'date=%s' % args.date]
if args.title:
