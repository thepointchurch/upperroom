...
import thepoint.resources.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(upload_to=thepoint.resources.models.get_attachment_filename, verbose_name="file"),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=thepoint.resources.models.get_feed_artwork_filename,
        ...
        migrations.AddIndex(
            model_name="attachment", index=models.Index(fields=["kind"], name="resources_a_kind_34af54_idx"),
        ),
        migrations.AddIndex(
            model_name="resource", index=models.Index(fields=["published"], name="resources_r_publish_bb2046_idx"),
        ),
        migrations.AddIndex(
            model_name="resource", index=models.Index(fields=["is_published"], name="resources_r_is_publ_7afbcf_idx"),
        ),
        migrations.AddIndex(
            model_name="resource", index=models.Index(fields=["is_private"], name="resources_r_is_priv_ae0b21_idx"),
        ),
        migrations.AddIndex(
            model_name="tag", index=models.Index(fields=["name"], name="resources_t_name_352b9c_idx"),
        ),
        migrations.AddIndex(
            model_name="tag", index=models.Index(fields=["is_exclusive"], name="resources_t_is_excl_1f4322_idx"),
        ),
        migrations.AddIndex(
            model_name="tag", index=models.Index(fields=["is_private"], name="resources_t_is_priv_0f2454_idx"),
        ),
