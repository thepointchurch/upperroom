...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('-y', '--year',
                            ...
                            type=int,
                            default=this_year(),
                            help=_('The year to generate the roster for'))
        parser.add_argument('-w', '--week-day',
                            dest='week_day',
                            type=int,
                            default=1,  # Sunday
        ...
        parser.add_argument('-o', '--output',
                            dest='output',
                            help=_('File to write the PDF to'))
    ...
    def handle(self, *args, **options):
        ...
        html = get_template('roster/pdf.html').render({
            ...
            'year': year,
            'meeting_list': Meeting.objects.all().filter(date__year=year,
