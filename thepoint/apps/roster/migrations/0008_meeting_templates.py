        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30,
                                          verbose_name='name')),
                ('week_day', models.SmallIntegerField(choices=[(1, 'Sunday'),
                                                               (2, 'Monday'),
                                                               (3, 'Tuesday'),
                                                               (4, 'Wednesday'),
                                                               (5, 'Thursday'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.SmallIntegerField(blank=True,
                                                   null=True,
                                                   verbose_name='order')),
                ('role_type', models.ForeignKey(to='roster.RoleType',
                                                on_delete=django.db.models.deletion.CASCADE)),
                ('template', models.ForeignKey(to='roster.MeetingTemplate',
                                               on_delete=django.db.models.deletion.CASCADE)),
            ],
        ),
        migrations.AddField(
            ...
            name='roles',
            field=models.ManyToManyField(to='roster.RoleType',
