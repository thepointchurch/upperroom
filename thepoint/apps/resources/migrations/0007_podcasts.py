        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mime_type_list', models.CharField(
                    ...
                    help_text=('A comma-separated list of MIME types. '
                ...
                ('copyright', models.CharField(verbose_name='copyright',
                                               ...
                                               null=True,
                                               blank=True)),
                ('artwork', models.FileField(verbose_name='artwork',
                                             upload_to=resources.models.get_feed_artwork_filename,
                                             null=True,
                                             blank=True)),
                ('is_podcast', models.BooleanField(verbose_name='podcast',
                                                   default=False)),
                ('owner_name', models.CharField(verbose_name='owner name',
                                                max_length=64,
                                                null=True,
                                                blank=True)),
                ('owner_email', models.CharField(verbose_name='owner email',
                                                 max_length=64,
                                                 null=True,
                                                 blank=True)),
                ('tags', models.ManyToManyField(verbose_name='tags',
                                                related_name='feeds',
                                                to='resources.Tag',
                                                blank=True)),
            ],
